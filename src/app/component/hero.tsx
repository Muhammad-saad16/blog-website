        ...
        <section className="relative min-h-[80vh] flex items-center">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div className="text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-teal-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                        Resources and insights
                    </h1>
                    <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto animate-fade-in animation-delay-300">
